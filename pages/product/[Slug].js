...
const Post = ({addtocart}) => {
  ...
  <div className="container px-5 py-10 mx-auto">
    <div className="lg:w-1/2 mx-auto flex flex-wrap">
      <img alt="ecommerce" className=" lg:w-1/2 w-full md:h-auto  object-scale-down object-center rounded   " src="https://m.media-amazon.com/images/I/716u270iUbL._SL1500_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-16 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button onClick={()=>{addtocart(Slug,1, 'this is the product', 58,'xl','red')}} className="flex  text-white bg-indigo-500 border-0 p-1 pt-2 md:py-2 md:px-3 focus:outline-none hover:bg-indigo-600 rounded mx-2 text-sm ">add to cart</button>
