        ...
        <div className="lg:w-2/3 md:w-2/3 mx-auto">
          ...
          <div className="flex flex-wrap font-semibold">
            ...
            <div className="flex flex-col w-full m-auto">
              ...
              <Link href={'/checkout'} className="m-auto"><button onClick={initiatepayment} disabled = {true}className="grow w-15 mt-4 mx-1  text-white bg-tahiti-200 disabled :bg-pink-300 border-0  py-2 px-1 focus:outline-none hover:bg-tahiti-300 rounded text-lg"><AiFillShopping className=" grow inline-block flex-wrap ml-0 "/> checkout</button></Link>
            </div>
