...
<div>
  ...
  <h2 className="mt-6 text-center text-3xl tracking-tight font-bold text-gray-900">Sign in to your account</h2>
    ...
    <div className="text-center"><Link href={"/login"}><a href="#" className="font-medium text-tahiti-200 hover:text-tahiti-300"> Login </a></Link></div>
...
<form className="mt-8  space-y-6" action="#" method="POST">
  ...
  <div/>
    ...
    <button type="submit" className=" group relative w-full flex justify-center my-3 py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-tahiti-200 hover:bg-tahiti-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500">
